...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT : **HERE IS THE ANSWER**  using var make the variable a global one no matter where it is used, const is used to declear the variable locally to the method it's used in. so when we turned the var to const the variable rando became undefined because it's just defined in the while loop.
  console.log(viewed);
